...
function generateTip() {
	...
	var elTip = document.querySelector('.js-tip');
	elTip.innerHTML = tip;
...
// DONE 1. Get random number from generateNumber()
// DONE 2. Use the random number to get the tip from the array
// DONE 3. Show the tip


// DONE Tip button click
